...
public class Timeslot {
    ...
    @JoinColumn(name="damka")
    private Doctor doctor;

    @ManyToOne(cascade= {CascadeType.PERSIST, CascadeType.MERGE, CascadeType.REMOVE})
    @JoinColumn(name="vcname")
    private VaccinationCenter mappingvaccinationcenter;
    ...
    public VaccinationCenter getVaccinationCenter() {return mappingvaccinationcenter;}
    //setters for mappingdoctor and mappingvaccinationcenter
    public void setVaccinationCenter(VaccinationCenter vc) {this.mappingvaccinationcenter=vc;}
